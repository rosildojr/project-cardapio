...
function checkOpenStatus() {
  ...
  if (day >= 1 && day <= 5 && hour >= 18 && hour < 23) {
    ...
    dateSpan.querySelector("span").innerHTML =
      '<i class="fas fa-check-circle"></i> Aberto agora - Seg à Sex 18:00-23:00';
  } else {
    dateSpan.classList.remove("bg-green-600");
    dateSpan.classList.add("bg-red-600");
    dateSpan.querySelector("span").innerHTML =
      '<i class="fas fa-times-circle"></i> Fechado - Abrimos Seg às 18:00';
  }
}
